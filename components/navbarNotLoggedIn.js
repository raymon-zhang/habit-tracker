            ...
            <div className="w-screen mx-auto px-8 sm:px-10 shadow-md">
                <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10 h-24 max-h-24">
                    ...
                    <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        <Link href="/login">
                            <a className="whitespace-nowrap text-base font-medium text-blue-600 hover:text-blue-700">
                                Sign in
                            </a>
                        </Link>
                        <Link href="/login">
                            <a className="ml-9 whitespace-nowrap inline-flex items-center justify-center px-6 py-2.5 border-none rounded-md shadow-none text-base font-medium text-white bg-blue-600 hover:bg-blue-700">
                                Sign up
                            </a>
                        </Link>
                    </div>
                    ...
                    <div className="rounded-lg shadow-lg bg-white divide-y-2 divide-gray-50">
                        <div className="pt-5 pb-6 px-5">
                            <div className="flex items-center justify-between">
                                <div>
                                    <HabitualLogo className="h-8 w-auto" />
                                </div>
                                <div className="-mr-2">
                                    <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
